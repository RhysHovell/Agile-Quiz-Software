<%-- 
    ...
    Created on : 14-Mar-2017, 16:37:23
    Author     : adammanion
--%>
...
<html lang = "en">
    ...
    <body>
        ...
        <form method="POST" action="StudentResults" class = "signin">
            <h2 class = "signin-heading">Enter Module To View Quiz Results</h2>
        ...
        <%
            ...
            List<List<String>> ResultList = (List<List<String>>) session.getAttribute("ResultList");
        ...
        <%    for (int i = 0; i < ResultList.get(0).size(); i++) {
                x = ResultList.get(2).get(i).toString();
                y = ResultList.get(0).get(i).toString();
                z = ResultList.get(1).get(i).toString();
        %>
        <p> Module: <%=x%>  </p>
        <p> Quiz Name: <%=y%>  </p>
        <p> Result: <%=z%>/100  </p>
